...
audio20 = fs.readFileSync('./X3/nayla20.m4a') 
		...
		//	if (nay.key.fromMe) return
			...
			reply('SUKSES!!!, JGN LUPA SUBSCRIBE https://youtube.com/channel/UCG3W7tLtj4V3XK1LxP7U0Aw')
			} catch {
			reply('LINK ERROR!')
			}
			break			  	
